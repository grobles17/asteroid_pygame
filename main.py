...
def main():
    ...
    score = Score()
    score.calculate_position() #calculates position before loop to avoid crash
        ...
        for asteroid in asteroids: #check if player´s "circle" collides with asteroid
            ...
            for shot in shots: #Check if any shot hits an asteroid
                if asteroid.collides_with(shot):
                    ...
                    score.score += asteroid.radius
                    score.calculate_position() #recalculates in case score very big to adjust
